...
import { useByIdBookingDetail } from "@/components/models/queries/booking";
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
export default function ActiveBookingsPage() {
  ...
  const [selectedBookingForPenalty, setSelectedBookingForPenalty] = useState<
    any | null
  >(null);
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-white dark:bg-gray-900 rounded-lg border border-gray-300 p-1  shadow-lg">
                  <DropdownMenuItem
                    ...
                    onClick={() => {
                      setSelectedBookingForPenalty(r); // 👈 MUHIM
                      setPaymentOpen(true);
                    }}
                  >
                    Qo'shimcha amallar
